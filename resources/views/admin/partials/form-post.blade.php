...
<form action="{{ route($post->title ? 'admin.post.update' : 'admin.post.store', [$post]) }}" method="post" enctype="multipart/form-data">
    @csrf
    @method( $methode )
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="form-group mb-3">
                ...
                <input class="form-control @error('title') is-invalid @enderror" id="title" type="text" placeholder="Titre de l'article" name="title"
            ...
            <div class="form-group mb-3">
                ...
                <textarea class="form-control @error('content') is-invalid @enderror" rows="10"
                          id="content" placeholder="Contenu de l'article" name="content">{{ old('content', $post->content) }}</textarea>
                @error('content')
                <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
